...
CREATE TABLE IF NOT EXISTS topdown_sector_snapshots(
    id BIGSERIAL PRIMARY KEY,
    company_ref_id BIGINT NOT NULL REFERENCES checklist_company_refs(id),
    review_id BIGINT NOT NULL REFERENCES research_reviews(id),
    version_no INTEGER NOT NULL,
    ...
    benchmark_source_evidence_id BIGINT REFERENCES research_evidence(id),
    ...
    supersedes_snapshot_id BIGINT REFERENCES topdown_sector_snapshots(id),
    created_by TEXT NOT NULL,
    created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP::text,
    UNIQUE(review_id,version_no)
);
CREATE INDEX IF NOT EXISTS ix_topdown_sector_review_version ON topdown_sector_snapshots(review_id,version_no DESC,id DESC);
CREATE INDEX IF NOT EXISTS ix_topdown_sector_company_date ON topdown_sector_snapshots(company_ref_id,as_of_date DESC,id DESC);
CREATE INDEX IF NOT EXISTS ix_topdown_sector_evidence ON topdown_sector_snapshots(benchmark_source_evidence_id);
CREATE INDEX IF NOT EXISTS ix_topdown_sector_supersedes ON topdown_sector_snapshots(supersedes_snapshot_id);

CREATE TABLE IF NOT EXISTS topdown_data_update_runs(
    id BIGSERIAL PRIMARY KEY,
    company_ref_id BIGINT NOT NULL REFERENCES checklist_company_refs(id),
    review_id BIGINT NOT NULL REFERENCES research_reviews(id),
...
CREATE INDEX IF NOT EXISTS ix_topdown_update_runs_review ON topdown_data_update_runs(review_id,id DESC);
CREATE INDEX IF NOT EXISTS ix_topdown_update_runs_company ON topdown_data_update_runs(company_ref_id,id DESC);

CREATE TABLE IF NOT EXISTS topdown_data_observations(
    id BIGSERIAL PRIMARY KEY,
    run_id BIGINT NOT NULL REFERENCES topdown_data_update_runs(id),
    company_ref_id BIGINT NOT NULL REFERENCES checklist_company_refs(id),
    review_id BIGINT NOT NULL REFERENCES research_reviews(id),
...
CREATE INDEX IF NOT EXISTS ix_topdown_observations_review_driver ON topdown_data_observations(review_id,driver_id,id DESC);
CREATE INDEX IF NOT EXISTS ix_topdown_observations_run ON topdown_data_observations(run_id,id);
CREATE INDEX IF NOT EXISTS ix_topdown_observations_company_date ON topdown_data_observations(company_ref_id,observation_date DESC,id DESC);

CREATE TABLE IF NOT EXISTS topdown_driver_suggestions(
    id BIGSERIAL PRIMARY KEY,
    run_id BIGINT NOT NULL REFERENCES topdown_data_update_runs(id),
    observation_id BIGINT NOT NULL REFERENCES topdown_data_observations(id),
    company_ref_id BIGINT NOT NULL REFERENCES checklist_company_refs(id),
    review_id BIGINT NOT NULL REFERENCES research_reviews(id),
    driver_id TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS ix_topdown_suggestions_review ON topdown_driver_suggestions(review_id,id DESC);
CREATE INDEX IF NOT EXISTS ix_topdown_suggestions_driver ON topdown_driver_suggestions(company_ref_id,driver_id,id DESC);
CREATE INDEX IF NOT EXISTS ix_topdown_suggestions_observation ON topdown_driver_suggestions(observation_id);

CREATE TABLE IF NOT EXISTS topdown_driver_decisions(
    id BIGSERIAL PRIMARY KEY,
    suggestion_id BIGINT NOT NULL UNIQUE REFERENCES topdown_driver_suggestions(id),
    company_ref_id BIGINT NOT NULL REFERENCES checklist_company_refs(id),
    review_id BIGINT NOT NULL REFERENCES research_reviews(id),
...
CREATE INDEX IF NOT EXISTS ix_topdown_decisions_review ON topdown_driver_decisions(review_id,id DESC);
CREATE INDEX IF NOT EXISTS ix_topdown_decisions_company ON topdown_driver_decisions(company_ref_id,id DESC);
