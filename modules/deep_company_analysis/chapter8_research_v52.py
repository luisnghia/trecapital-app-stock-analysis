...
research, and V56 is re-exported last so explicit direct official-URL ingestion is available from
the same Chapter 8 research agent. This keeps one analyst workspace/state store while preserving
earlier phase compatibility checks.
"""
