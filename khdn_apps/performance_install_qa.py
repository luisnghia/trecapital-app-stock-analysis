...
def main():
    ...
    checks={
        ...
        "light_native_menu_surface": 'html.khdn-light [data-testid="stMainMenuPopover"]' in light_controls and 'background:#FFFFFF!important' in light_controls,
        "light_theme_switcher_contrast": 'data-testid="stThemeSwitcher"' in light_controls and 'color:#0B2A25!important' in light_controls and 'background:#FFF1C2!important' in light_controls,
        "light_native_menu_actions_contrast": 'data-testid="stMainMenuItemLabel"' in light_controls and '[role="menuitem"]:hover' in light_controls,
        "light_baseweb_menu_descendants_contrast": '[data-baseweb="menu"] [role="option"] *' in light_controls and '[role="listbox"] [role="option"] *' in light_controls,
        "light_popover_contrast": '[data-testid="stPopoverBody"]' in light_controls and '[role="tooltip"]' in light_controls,
