...
def main():
    ...
    checks={
        ...
        'light_oaktree_bg': cfg['theme']['light'].get('backgroundColor')=='#FFFFFF',
        'light_oaktree_secondary': cfg['theme']['light'].get('secondaryBackgroundColor')=='#FFFFFF',
        'light_oaktree_text': cfg['theme']['light'].get('textColor')=='#17231F',
        'light_oaktree_border': cfg['theme']['light'].get('borderColor')=='#C9DCD3',
        'streamlit_sees_dark_default': st_config.get_option('theme.base')=='dark',
        'streamlit_sees_light_theme': st_config.get_option('theme.light.backgroundColor')=='#FFFFFF',
        ...
        'light_css_oaktree_tokens': '--oak-pine:#12362F' in theme and '--oak-gold:#F4B41A' in theme and '--oak-cream:#FFFFFF' in theme and '--oak-line:#C9DCD3' in theme,
        'light_css_oaktree_sidebar': 'linear-gradient(180deg,#F0F7F3 0%,#FFFFFF 100%)' in theme,
        ...
        'light_css_oaktree_table': 'html.khdn-light .khdn-catalog-table th' in theme and 'background:#F0F7F3!important' in theme,
        ...
        'component_light_oaktree': "body.light input" in component and '#C9DCD3' in component and '#F4B41A' in component and '#0B2A25' in component,
